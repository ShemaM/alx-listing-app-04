        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-4 lg:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              Your premier destination for luxury properties. We offer a curated selection of the world&apos;s finest homes.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/LuxuryEstates"
                target="_blank"
              ...
              <a
                href="https://twitter.com/LuxuryEstates"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://www.instagram.com/LuxuryEstates"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
